...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto px-4 pt-28 pb-8 sm:pt-32">
      ...
      <div className="relative z-10 w-full max-w-[720px] max-h-[calc(100vh-9rem)] overflow-y-auto rounded-2xl p-6 text-white shadow-2xl border border-neutral-cs-10 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 animate-[member-popup-show_200ms_ease-out] sm:max-h-[calc(100vh-10rem)] sm:p-8">
        <button
          type="button"
          aria-label="Close member detail"
          onClick={onClose}
